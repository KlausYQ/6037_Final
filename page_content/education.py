...
def education_page():
    ...
    with tab1:
        ...
        st.markdown(f"""
        ### The Chinese University of Hong Kong <img src='data:image/png;base64,{logo_cuhk}' width='40' style='margin-left:8px; vertical-align:middle;'/>  
        ...
        *August 2024 - November 2025*
        ...
        ### Shanghai University <img src='data:image/png;base64,{logo_shu}' width='40' style='margin-left:8px; vertical-align:middle;'/>  
        ...
        *September 2018 – July 2022*
        ...
        ### University of Technology Sydney <img src='data:image/png;base64,{logo_uts}' width='40' style='margin-left:8px; vertical-align:middle;'/>  
